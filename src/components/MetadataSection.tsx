...
const MetadataSection = ({ resultMetadata }: MetadataSectionProps) => {
  ...
  return (
    <section className="rbscv-meta-bar">
      ...
      {resultMetadata.folder && (
        <>
          <div
            id={`${resultMetadata.folder.name}-${resultMetadata.folder}`}
          ...
          >
            ...
            <span className="rbscv-meta-item__label">
              {resultMetadata.folder.name}
            </span>
            <span className="rbscv-meta-item__label">·</span>
            <span className="rbscv-meta-item__label">
              {`${resultMetadata.folder.filesFound} ${resultMetadata.folder.fileType} found`}
            </span>
            <span className="rbscv-meta-item__label">·</span>
            <span className="rbscv-meta-item__label">
              {resultMetadata.folder.rowCount} rows
            </span>
          </div>
          <div>
            {resultMetadata.folder.error && (
              <>
                <span className="rbscv-meta-item__label-error">
                  {resultMetadata.folder.error}
                </span>
              </>
            )}
